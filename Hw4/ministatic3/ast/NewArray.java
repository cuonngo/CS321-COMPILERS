...
public class NewArray extends Expr {
	...
	//size.require(typing)		- if Expr is empty? int []?
	size.require(typing, Type.INT);		//int [5]?
	return super.type = new ArrayType(type);	//2 type. Super.type and this.type
    }
    ...
    public VarSet analyze(InitAnalysis init, VarSet initialized) {
        //return null; // TODO: replace this with correct code!
	return size.analyze(init, initialized);
    }
}
